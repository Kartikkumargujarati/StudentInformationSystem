...
String sql = "update  studentinfo set  stud_first_name='"+firstname+"', stud_last_name='"+lastname+"', stud_date_of_birth='"+dateofbirth+"', stud_address='"+address+"', stud_major='"+major+"', phone_no='"+phoneno+"' where student_id='"+id+"'"; 
